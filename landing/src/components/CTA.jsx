    ...
    <section id="download" className="py-24 md:py-32 relative overflow-hidden">
      ...
      <div className="section-container relative z-10">
        <motion.div
          ...
          className="grad-border p-10 md:p-16 text-center relative overflow-hidden"
        >
          {/* Background gradient */}
          <div
          ...
          <div className="relative z-10">
            ...
            >
              ...
              <span className="text-sm text-white/70 font-medium">Free to download — No subscription required</span>
            </motion.div>
            ...
            <p className="text-white/50 text-lg max-w-lg mx-auto leading-relaxed mb-10">
              Join thousands of people who've stopped wondering what to wear. Download DrapeAI — your AI wardrobe is waiting.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <motion.a
                ...
                whileTap={{ scale: 0.97 }}
                className="flex items-center gap-3 glass-strong px-6 py-4 rounded-2xl border border-white/15 hover:border-white/30 transition-all group"
              >
                ...
                <div className="text-left">
                  <p className="text-white/50 text-[10px] font-medium uppercase tracking-wider">Download on the</p>
              ...
              >
                ...
                <div className="text-left">
                  <p className="text-white/50 text-[10px] font-medium uppercase tracking-wider">Get it on</p>
            ...
            <div className="flex flex-wrap gap-6 justify-center mt-10">
              {[
                ...
                <div key={badge.text} className="flex items-center gap-2 text-white/35">
